...
def add_car_to_customer():
    customer_car_info = get_object_info(columns=['customer_id', 'car_model_id', 'reg_plate', 'color'])
    add_customer_car(*customer_car_info)


def add_car_to_product():
    product_car_info = get_object_info(columns=['product_id', 'car_model_id'])
    add_product_car(*product_car_info)


def create_new_car_brand():
    car_brand_info = get_object_info(columns=['car_brand_name'])
    add_car_brand(*car_brand_info)


def create_new_car_model():
    car_model_info = get_object_info(columns=['car_model_name', 'car_model_year', 'car_model_car_brand_id'])
