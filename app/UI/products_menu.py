...
def add_info_to_products():
    ...
    product_supplier_id = input('Enter product supplier id: ')
    product_category_id = input('Enter product category id: ')
    product_manufacturer_id = input('Enter manufacturer id: ')
